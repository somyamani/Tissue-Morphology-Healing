...
def plot_recovery():
    ...
    ax[1,0].scatter(df['PC1']+np.random.uniform(-0.005,0.005,(len(df))),df['PC2']+np.random.uniform(-0.005,0.005,(len(df))),s=0.5,c=df['nsc1_red'],cmap='viridis', zorder=0, vmin=0,vmax=1)
    ax[1,1].scatter(df['PC1']+np.random.uniform(-0.005,0.005,(len(df))),df['PC2']+np.random.uniform(-0.005,0.005,(len(df))),s=0.5,c=df['nsc1_unch'],cmap='viridis', zorder=0,vmin=0,vmax=1)
    ...
    ax[2,0].scatter(df['PC1']+np.random.uniform(-0.005,0.005,(len(df))),df['PC2']+np.random.uniform(-0.005,0.005,(len(df))),s=0.5,c=df['n5sc1_red'],cmap='viridis', zorder=0, vmin=0,vmax=1)
    ax[2,1].scatter(df['PC1']+np.random.uniform(-0.005,0.005,(len(df))),df['PC2']+np.random.uniform(-0.005,0.005,(len(df))),s=0.5,c=df['n5sc1_unch'],cmap='viridis', zorder=0,vmin=0,vmax=1)
    ...
    fig.savefig('/Users/somya/Documents/SIGMIG_from_Bigram2/Dat_3_from_cslm/fig3/recovery3_scatters.png')
    plt.close('all')
    return 0
